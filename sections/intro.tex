...
\begin{onecolentry}
	A front-end engineer with a strong foundation in real-time 3D graphics and performance optimization, proficient in WebGL, Three.js, and JavaScript. Experienced in developing interactive web-based visualizations and managing large-scale 3D datasets like 3D Tiles and glTF. I am well-suited to contribute to the cutting-edge 3D visualization tools at \textbf{Intratech Corp}.
\end{onecolentry}